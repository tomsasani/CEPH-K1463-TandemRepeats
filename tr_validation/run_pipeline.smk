...
SAMPLE2BAM = dict(zip(SAMPLES, ORIG_BAM_FHS))
...
rule all:
    input: expand("tr_validation/fig/{sample}.dnm.read_support.png", sample=["2189", "2216", "2188", "2209"])
...
rule validate_inherited:
    input:
        ...
        mutations = "/scratch/ucgd/lustre-work/quinlan/u0055382/src/CEPH-K1463-TandemRepeats/distance/GRCh38/dashnow/fd6baac/element_validation_consistent_GTs/consistent_0_0.element_trio.tsv"
    output: "tr_validation/csv/{sample}.inherited.read_support.csv"
    params:
        kid_bam = lambda wildcards: SAMPLE2BAM[wildcards.sample],
        mom_bam = lambda wildcards: SAMPLE2BAM[SAMPLE2MOM[wildcards.sample]],
        dad_bam = lambda wildcards: SAMPLE2BAM[SAMPLE2DAD[wildcards.sample]]
